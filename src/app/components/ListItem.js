export default function ListItem({coffeeShop = "-", coffeeName = "-", rating = 4, price = "10,000"}) {
    return (
        <div className="w-full h-20 border-2 rounded-xl p-2 flex flex-row items-center justify-between">
